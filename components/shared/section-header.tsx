...
export function SectionHeader({
  ...
  return (
    <div className={cn("space-y-4 md:space-y-6", align === "center" && "text-center", className)}>
      {badge && (
      ...
      <Tag className={cn("font-serif font-bold", SECTION_HEADER_SIZE[size])}>{renderTitle()}</Tag>
      {subtitle && (
        <p
          className={cn(
