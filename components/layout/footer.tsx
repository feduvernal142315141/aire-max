    ...
    <footer className="relative overflow-hidden">
      ...
      <div className="relative border-b border-[#037ecc]/10">
        <div className="container mx-auto px-6 py-8 lg:px-12">
          <div className="animate-fade-up flex flex-col items-center justify-between gap-6 rounded-2xl border border-white/40 bg-white/60 p-6 shadow-[0_10px_40px_rgba(7,156,251,0.06)] backdrop-blur-xl lg:flex-row lg:gap-8 lg:p-8">
            {/* Trust badges */}
            ...
            >
              ...
              <div className="space-y-3">
                <a
                  ...
                  className="group flex items-center gap-3 text-sm text-[#0f172a] transition-all duration-200 hover:translate-x-1 hover:text-[#037ecc]"
                >
        ...
        <div className="container mx-auto px-6 py-8 lg:px-12">
          <div className="flex flex-col items-center justify-between gap-4 text-sm sm:flex-row">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-2 text-[#475569] transition-all duration-200 hover:scale-105 hover:text-[#037ecc]"
            >
